    ...
    <div class="flex-col group_3">
      <div class="flex-row section_1">
        <img alt=""
            ...
            class="image_4"
        />
        <span class="text_2">Fan Chen</span>
      </div>
